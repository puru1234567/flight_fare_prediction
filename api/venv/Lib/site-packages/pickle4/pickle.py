...
class _Pickler(object):
    ...
    def save(self, obj, save_persistent_id=True):
        ...
        # TODO Is six.string_types (Python 2.x: basestring, Python 3.x: str) the most suitable?
        #      CPython 2.x used: if type(rv) is StringType
        #      CPython 3.x uses: if isinstance(rv, str)
